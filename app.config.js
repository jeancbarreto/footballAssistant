...
export default () => ({
  expo: {
    ...
    icon: "./assets/images/sportiq_app.png",
    scheme: "myapp-dev",
    jsEngine: "hermes",
    userInterfaceStyle: "automatic",
    splash: {
    "image": "./assets/images/sportiq_app.png"
  },
    permissions: [
    ...
    android: {
      adaptiveIcon: {
        foregroundImage: "./assets/images/sportiq_app.png",
    ...
    plugins: [
      ...
      [
        "expo-asset",
        {
          "assets": ["./assets/images/sportiq_app.png"]
        }
      ],
